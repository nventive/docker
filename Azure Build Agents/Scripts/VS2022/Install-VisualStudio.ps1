...
if($env:BUILD_TOOLS) {
  ...
  if($env:PREVIEW) {
    $VSBootstrapperURL = 'https://aka.ms/vs/17/pre/vs_BuildTools.exe'
  }
  else {
  ...
  if($env:PREVIEW) {
    $VSBootstrapperURL = 'https://aka.ms/vs/17/pre/vs_Enterprise.exe'
  }
  else {
...
$SoftwareName = "Visual Studio 2022 Enterprise"
